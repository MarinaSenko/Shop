            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <p>Акционная цена</p>
                        <input type="text" name="sale_price" placeholder="" value="<?php echo $product['sale_price']; ?>">
                        ...
                        <p>Характеристики/p>
                        <input type="text" name="features" placeholder="" value="<?php echo $product['features']; ?>">
                        ...
                        <select name="is_stock">
                            <option value="1" <?php if ($product['is_stock'] == 1) echo ' selected="selected"'; ?>>Да</option>
                            <option value="0" <?php if ($product['is_stock'] == 0) echo ' selected="selected"'; ?>>Нет</option>
                        </select>
                        ...
                        <p>Уценка</p>
                        <select name="is_stock">
                            <option value="1" <?php if ($product['is_reduction'] == 1) echo ' selected="selected"'; ?>>Да</option>
                            <option value="0" <?php if ($product['is_reduction'] == 0) echo ' selected="selected"'; ?>>Нет</option>
                        </select>
